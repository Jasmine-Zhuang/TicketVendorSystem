...
*/
        ...
        fm.AddFlight("CZ333", "Ottawa","Vancouver",
                (ArrayList<String>) Arrays.asList("2021","12","9","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","9","10","45","0"),"Small", 450, "10F");

        fm.AddFlight("CZ334","Ottawa", "Vancouver",
                (ArrayList<String>) Arrays.asList("2021","12","10","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","10","10","45","0"),"Medium", 450, "10G");

        fm.AddFlight("CZ335", "Ottawa", "Vancouver",
                (ArrayList<String>) Arrays.asList("2021","12","11","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","11","10","45","0"),"Large", 450, "10C");
        ...
        fm.AddFlight("CZ339", "Ottawa","Montreal",
                (ArrayList<String>) Arrays.asList("2021","12","9","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","9","10","45","0"),"Small", 450, "10W");

        fm.AddFlight("CZ340","Ottawa", "Montreal",
                (ArrayList<String>) Arrays.asList("2021","12","10","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","10","10","45","0"),"Medium", 450, "10L");

        fm.AddFlight("CZ341", "Ottawa", "Montreal",
                (ArrayList<String>) Arrays.asList("2021","12","11","8","50","0"),
                (ArrayList<String>)Arrays.asList("2021","12","11","10","45","0"),"Large", 450, "10P");
